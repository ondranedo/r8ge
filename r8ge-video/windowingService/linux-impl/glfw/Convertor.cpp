...
namespace r8ge {
    namespace video {
        Key GLFWConvertor::convertKeyCode(int glfwKeyCode) {
            switch (glfwKeyCode) {
                case GLFW_MOUSE_BUTTON_1: return Key::MBUTTON_LEFT;
                case GLFW_MOUSE_BUTTON_2: return Key::MBUTTON_RIGHT;
                case GLFW_MOUSE_BUTTON_3: return Key::MBUTTON_MIDDLE;
                case GLFW_MOUSE_BUTTON_4: return Key::MBUTTON_4;
                case GLFW_MOUSE_BUTTON_5: return Key::MBUTTON_5;
                case GLFW_MOUSE_BUTTON_6: return Key::MBUTTON_6;
                case GLFW_MOUSE_BUTTON_7: return Key::MBUTTON_7;
                case GLFW_MOUSE_BUTTON_8: return Key::MBUTTON_8;
